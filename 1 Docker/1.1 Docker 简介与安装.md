...
而这幅图的右边，则用了一个 Docker Engine 的软件替换了 Hypervisor，属于[操作系统层面的虚拟化技术](https://en.wikipedia.org/wiki/Container_(virtualization)),因为上层只是与系统其它部分隔离开的一系列进程，所以叫做[容器](https://www.redhat.com/zh/topics/containers/whats-a-linux-container)。
